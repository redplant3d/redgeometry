...
launcher.addCanvas2D("ecs", AnimationMode.Step, EcsAppPart);
...
launcher.addCanvasWebGPU("weggputest", AnimationMode.Step, WebGpuTestAppPart);
launcher.init("weggputest");
