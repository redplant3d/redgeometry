...
export function insertOuterJoin(
    ...
    switch (join) {
        ...
        case 1 /* MITER */: {
            ...
            k = k.mulS(2 * d).divS(k.lengthSq());

            if (k.lengthSq() <= mld * mld) {
                path.lineTo(p.add(k));
            }
        ...
        case 2 /* MITER_CLIP */: {
            ...
            if (k.lengthSq() <= mld * mld) {
                ...
                path.lineTo(pp0.subMulS(n0.perpCW(), mld));
                path.lineTo(pp2.addMulS(n1.perpCW(), mld));
            } else {
        ...
        case 3 /* ROUND */: {
            ...
            if (n0.dot(n1) < 0) {
                ...
                const nm = pp2.sub(pp0).unitOrZero().perpCW();
