 ...
 */
export function isSimpleQuad(c: ReadonlyBezier2Curve2, cosTolerance: number): boolean {
 ...
 */
export function isSimpleConic(c: ReadonlyBezierRCurve2, simplifyTolerance: number): boolean {
    const v1 = c.p1.sub(c.p0);
    const v2 = c.p2.sub(c.p1);
