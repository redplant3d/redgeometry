...
export class Edge2 {
    ...
    constructor(p0: Point2, p1: Point2) {
        this.p0 = p0;
        this.p1 = p1;
    }
    ...
    public get normal(): Edge2 {
        return new Edge2(this.p0, this.p0.add(this.vector.normal));
    }
    ...
    public getClosestPointDistance(p: Point2): number {
        return this.getClosestPoint(p).sub(p).length;
    }
...
export class Edge3 {
    ...
    public getNormalAround(v: Vector3): Edge3 {
        return new Edge3(this.p0, this.p0.add(this.vector.cross(v)));
    }
